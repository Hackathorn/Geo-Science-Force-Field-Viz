...
{
	public string fileLocation = "C:\Users\Richard\Documents\myPython\NetCDP-3Dtexture\server\data\flattened.txt";
	//public string fileLocation = "http://localhost:5000/api";
